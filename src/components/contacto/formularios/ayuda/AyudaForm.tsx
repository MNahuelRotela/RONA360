...
const AyudaForm: React.FC = () => {
  ...
  return (
    ...
    <div className="max-w-2xl mx-auto w-full p-6 rounded-2xl shadow-lg mt-4 mb-4 bg-[#FFFFFF] ">
      ...
      <input type="hidden" name="retURL" value="https://congreso.somosawaq.org/contactmessage"/>
...
<input type="hidden" name="debug" value=1>                              
 value="neha.sharma21@concentrix.com">                                   */}
    ...
    <label htmlFor="description"></label><textarea name="description" className='w-full px-2 py-1 border border-black rounded-md focus:outline-none focus:border-[#8DC73F] focus:border-2 ' placeholder={content?.contactform[language].inputDescription} required></textarea><br/>
  ...
  <option value="English" selected={language === 'en'}>English</option>
                ...
                <select id="00N07000002KfuU" name="00N07000002KfuU" title="Case Origin" defaultValue="ContactForm" hidden>
                <option value="">--None--</option>
