...
export const MessagePreInscription = () => {
      ...
      <div data-aos="zoom-in" className="w-full h-[100vh] mt-20 ">
        ...
        <div className="flex justify-center bg-slate-100 ">
          ...
          <div className="w-full flex flex-col items-center justify-center mx-10 mt-4 ">
            ...
            <img src="https://somosawaqblob.blob.core.windows.net/congress/contact/messageilustration1.png" alt="messageilustration" className="h-40 flex" />
            <p className="text-center text-sm font-extrabold text-[#9CC24D] mt-4 mb-4">
              {content?.contactform[language].messajePage4}
            </p>
          </div>
