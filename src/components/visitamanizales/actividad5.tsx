...
export const Actividad5: React.FC = () => {
  ...
  return (
    <div className="w-full grid grid-cols-2 xs:grid-cols-1 sm:grid-cols-1" data-aos="fade-right">
      ...
      <div className="w-full h-full">
        <img
          src={`https://somosawaqblob.blob.core.windows.net/congress/visitmanizales/centro-manizales.png`}
          alt="Caldas"
      ...
      <div className=" flex justify-center items-center flex-col px-10 text-left text-balance py-10 bg-[#FDE5AE] xs:px-12 sm:px-12 md:px-12">
        ...
        {content?.visitManizales[language].quehacer.actividades.actividad5.titulo}
        </h3>
        <h3 className=" xs:px-2 sm:px-2 xs:text-xl sm:text-xl  text-2xl font-bold xs:text-center sm:text-center text-center">
        {content?.visitManizales[language].quehacer.actividades.actividad5.subtitulo}
        </h3>
        <p className="mt-8 xs:text-center sm:text-center text-left flex justify-center text-base">
        {content?.visitManizales[language].quehacer.actividades.actividad5.descripcion}
        </p>
        <p className="mt-4 xs:text-center sm:text-center text-left flex justify-center text-base">
        {content?.visitManizales[language].quehacer.actividades.actividad5.descripcion2}
        </p>
       ...
       <div className="self-start  relative">
        ...
        {content?.visitManizales[language].quehacer.actividades.actividad5.textobold}
        </p>
       </div>

        <Link to="https://centrohistoricomanizales.com" target="_blank" className=" flex justify-center mt-8">
        <div className="flex flex-col justify-center items-center">

        <img src={`https://somosawaqblob.blob.core.windows.net/congress/visitmanizales/centro-logo.png`} alt="Caldas" className="w-20  object-cover" loading="lazy" draggable="false" />
        </div>
        </Link>
        ...
        {/* <div className=" flex gap-x-4 justify-start xs:justify-center sm:justify-center">
          <Link to="/congreso" className=" flex justify-center">
            ...
            {content?.visitManizales[language].quehacer.actividades.actividad5.button}
            </button>
          </Link>
        </div> */}
        </div>
