...
export const Actividad1: React.FC = () => {
  ...
  return (
    <div className="w-full grid grid-cols-2 xs:grid-cols-1 sm:grid-cols-1" data-aos="fade-right">
      ...
      <div className="w-full h-full">
        <img
          src={`https://somosawaqblob.blob.core.windows.net/congress/visitmanizales/tour-de-orquideas.png`}
          alt="Caldas"
      ...
      <div className=" flex justify-center items-center flex-col px-10 text-left text-balance py-10 bg-[#FDE5AE] xs:px-12 sm:px-12 md:px-12">
        ...
        {content?.visitManizales[language].quehacer.actividades.actividad1.titulo}
        </h3>
        <h3 className=" xs:px-2 sm:px-2 xs:text-xl sm:text-xl  text-2xl font-bold xs:text-center sm:text-center text-center">
        {content?.visitManizales[language].quehacer.actividades.actividad1.subtitulo}
        </h3>
        <p className="mt-8 xs:text-center sm:text-center text-left flex justify-center text-base">
        {content?.visitManizales[language].quehacer.actividades.actividad1.descripcion}
        </p>
        <ul className="mt-4 xs:text-center sm:text-center text-left text-base list-disc ">
          <p className="">

        {content?.visitManizales[language].quehacer.actividades.actividad1.ul1.title}
          </p>
        <li className="ml-5">{content?.visitManizales[language].quehacer.actividades.actividad1.ul1.li1}</li>
        <li className="ml-5">{content?.visitManizales[language].quehacer.actividades.actividad1.ul1.li2}</li>
        <li className="ml-5">{content?.visitManizales[language].quehacer.actividades.actividad1.ul1.li3}</li>
        </ul>
       
       <div className="self-start  relative">

        <p className="mt-4 xs:text-center sm:text-center text-left font-bold font-open-sans">
        {content?.visitManizales[language].quehacer.actividades.actividad1.textobold}
        </p>
       </div>
        ...
        <div className=" flex gap-x-4 justify-start xs:justify-center sm:justify-center">
            ...
            {content?.visitManizales[language].quehacer.actividades.actividad1.button}
            </button>
