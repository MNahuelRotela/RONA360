...
export const Sponsor5: React.FC =() => {
        ...
        <div className=" py-16 w-auto h-auto lg:w-[100%]  bg-gray flex md:h-auto sm:h-auto sm:w-auto" >
          <div className="flex w-auto h-auto lg:w-[100%] mx-[8%] sm:mx-10 flex-row  my-auto box-border md:flex-col sm:flex-col xs:flex-col">
            ...
            <div className=" w-[80%] ml-12 xl:ml-12 xl:pl-12 sm:w-auto sm:mx-6 xs:w-auto xs:mx-6 mr-12 justify-center md:w-auto md:text-center md:mx-10 sm:text-center lg:w-[90%] 2xl:pl-12">
                <h2 data-aos="fade-up" className="my-6 text-[2.489rem] font-bold md:mt-6 sm:mt-5 sm:text-4xl sm:leading-10 lg:text-4xl">{content?.sponsors[language].sponsor5.h2}</h2>
                <h3 data-aos="fade-up" className="my-6 text-[#666666] text-base text-justify  md:mb-12 md:text-base sm:text-center md:text-center">{content?.sponsors[language].sponsor5.h3}</h3>
              <button data-aos="flip-left" className="buttonGreenHome md:mx-auto sm:mx-auto sm:text-ss underline "><Link to='https://www.humanspro.org/' target="_blank" className="md:text-ss md:p-2 sm:text-ss sm:p-1">{content?.sponsors[language].sponsor5.button} </Link></button>
            </div>
        </div>
      </div>
    </div>
